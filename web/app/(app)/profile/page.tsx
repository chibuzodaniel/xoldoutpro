      ...
      <div className="px-4 -mt-9">
        ...
        <h1 className="flex items-center gap-1.5 font-serif text-xl">
          ...
          {appUser.isVerified ? (
            ...
            <Link
              href="/verification"
              className="inline-flex items-center gap-1 rounded-full border border-red/40 bg-red/10 px-2.5 py-1 text-[11px] font-semibold text-red-soft shrink-0 animate-pulse"
            >
        ...
        <div className="flex flex-col divide-y divide-line-soft border-y border-line-soft mb-6">
          ...
          <Link href="/billboards" className="flex items-center gap-3 py-3">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="h-4 w-4 text-ink-3 shrink-0">
              <rect x="3" y="5" width="18" height="12" rx="1.5" />
              <path d="M8 21h8M12 17v4" strokeLinecap="round" />
            </svg>
            <div className="flex-1">
              <p className="text-sm font-semibold">Billboards</p>
              <p className="text-xs text-ink-3">Put your artwork in the Discover rotation</p>
            </div>
            <span className="text-ink-3">›</span>
          </Link>
        </div>
